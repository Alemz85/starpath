...
- `user/profile.yml` — User profile (name, identity)
- `user/cv.md` — CV for proof points in drafts
...
2. Read `user/cv.md` for proof points
3. Read `user/profile.yml` for candidate name and identity
...
- Use the candidate's name from `user/profile.yml`
