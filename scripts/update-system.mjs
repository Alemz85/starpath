...
//
// NOTE: .mjs paths here are flat (root-level) to match upstream santifer repo
// layout. Local layout has these in scripts/. Auto-update for .mjs files is
// currently broken — fix as part of fork-divergence decision.
const SYSTEM_PATHS = [
  'modes/_shared.md',
  'modes/oferta.md',
  'modes/pdf.md',
