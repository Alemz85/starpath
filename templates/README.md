...
| `portals.example.yml` | Onboarding | Example portal scanner configuration (copy to `user/portals.yml` to activate) |
...
**To activate:** Copy to `user/portals.yml` and customize `title_filter.positive` keywords for your target roles. Add or remove companies as needed.
